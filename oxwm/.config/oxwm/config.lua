...
local bar_font = "JetBrainsMonoNerdFontPropo:style=Regular:size=10"
...
oxwm.key.bind({ modkey }, "C", oxwm.spawn({"sh", "-c", "rofi -show calc"}))
...
-- Layout management
oxwm.key.bind({ modkey }, "R", oxwm.layout.set("normie"))
...
oxwm.autostart("feh --bg-scale ~/backgrounds/3840x2160.png") 
